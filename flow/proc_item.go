...
// // Type ...
// func (pi *ProcItem) Type() ItemType {
// 	return ItemTypeProc
// }

// // Conf ...
// func (pi *ProcItem) Conf() conf.Conf {
// 	return pi.c
// }

// // PreviousCount ...
// func (pi *ProcItem) PreviousCount() int {
// 	return len(pi.pr)
// }

// // Previous ...
// func (pi *ProcItem) Previous(index int) Item {
// 	return pi.pr[index]
// }

// // NextCount ...
// func (pi *ProcItem) NextCount() int {
// 	return len(pi.ne)
// }

// // Next ...
// func (pi *ProcItem) Next(index int) Item {
// 	return pi.ne[index]
// }

// // Visit ...
// func (pi *ProcItem) Visit(ito func(Item)) {
// 	ito(pi)
// 	for _, n := range pi.ne {
// 		n.Visit(ito)
// 	}
